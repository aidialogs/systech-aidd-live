...
- [ ] Добавить job для запуска unit тестов (pytest)

#### Линтеры и форматирование
- [ ] Добавить проверку ruff (линтер для Python)
- [ ] Добавить проверку форматирования (ruff format)
- [ ] Добавить проверку типов (mypy)

#### Оптимизация workflow
- [ ] Настроить параллельный запуск тестов и линтеров
- [ ] Сборка образов только при успешных тестах
- [ ] Добавить кэширование зависимостей (uv cache)

#### Отчетность
- [ ] Добавить GitHub Job Summary с результатами тестов
- [ ] Добавить badge с результатами CI в README.md


**Результат:** 
CI/CD пайплайн с автоматическими проверками качества кода. Образы собираются только если все тесты и проверки пройдены успешно.
