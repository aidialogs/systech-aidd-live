<!-- 51e29169-2dd2-428d-a4c1-5ce5c534a073 4d614306-8bde-4e67-8966-6a9b6ec85c86 -->
...
- [ ] Создать frontend/doc/frontend-vision.md с описанием архитектуры и принципов разработки (по аналогии с doc/vision.md)
- [ ] Создать doc/adrs/ADR-07.md с обоснованием выбора технологического стека (Next.js, TypeScript, shadcn/ui, Tailwind CSS, pnpm)
- [ ] Инициализировать Next.js проект в директории frontend/ с TypeScript и Tailwind CSS
- [ ] Установить и настроить shadcn/ui, добавить первые компоненты (button, card)
- [ ] Настроить TypeScript strict mode, ESLint, Prettier
- [ ] Создать базовую структуру директорий (components/, lib/, types/)
- [ ] Добавить команды для frontend в корневой Makefile (frontend-install, frontend-dev, frontend-lint, etc.)
