...
// Fallback data - keeping for reference
...
export function ChartAreaInteractive({
  ...
  const [timeRange, setTimeRange] = React.useState(activity.time_range)
  ...
  const chartData = React.useMemo(
    () =>
      activity.data_points.map((point) => ({
  ...
  const timeRangeLabel = timeRange === "7d" ? "Last 7 days" : "Last 30 days"
